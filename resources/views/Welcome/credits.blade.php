...
<div class="container-fluid">
    ...
    <div class="text-block text-block-typical">
        ...
        <p>Horario de atención: 7:00 - 17:00hrs </p>
					...
					<article class="card-typical">
						<div class="card-typical-section">
							<div class="user-card-row">
								<div class="tbl-row">
									<div class="tbl-cell">
										<p class="user-card-row-name">Elaboración</p>
						...
						<div class="card-typical-section">
							<div class="card-typical-linked">
								<p>Nunca te canses de intentar que tu vida sea mejor, la perseverancia siempre tiene su recompensa.</p>
								</br><p ALIGN=right>2017</p>
							</div>
						</div>
					</article><!--.card-typical-->
				</div><div class="card-grid-col">
