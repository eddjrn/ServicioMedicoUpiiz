...
<div class="container-fluid">
	<div id="row{{$student['id']}}">
		<div class="row moreBtn">
		    ...
		    <div class="col-lg-2 col-md-2 col-sm-2 hidden-lg-down helpHighlight" style="word-wrap: break-word;">
		    ...
		    @endif
		    <div class="col-lg-1 col-md-2 col-sm-2 col-xs-12 helpHighlight">
		        <div class="font-11 color-blue-grey-lighter uppercase">Boleta</div>
		            {{$user['identificacion']}}
		    </div>
		    <div class="col-lg-1 col-md-2 col-sm-2 col-xs-12 helpHighlight" style="word-wrap: break-word;">
		    ...
		    @if($indexSection == 4)
		    <div class="col-lg-1 col-md-1 col-sm-2 hidden-lg-down helpHighlight">
		    ...
		    @else
		    <div class="col-lg-1 col-md-1 col-sm-2 hidden-lg-down helpHighlight" style="word-wrap: break-word;">
		    ...
		    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-4">
		        <div class="font-11 color-blue-grey-lighter uppercase">Doc.</div>
		            <button type="button"
